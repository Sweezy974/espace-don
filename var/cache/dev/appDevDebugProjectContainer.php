...
class appDevDebugProjectContainer extends Container
{
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Donation\DonationBundle\Form\RegistrationAssociationType A Donation\DonationBundle\Form\RegistrationAssociationType instance.
     */
    protected function getApp_Form_RegistrationService()
    {
        return $this->services['app.form.registration'] = new \Donation\DonationBundle\Form\RegistrationAssociationType('Donation\\DonationBundle\\Entity\\Utilisateurs');
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('S7lPZBk6Ij', '', (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('reZ1MLUl+L', '', 'i6sZpcY30eItQPfCKpe14w', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('SwfuxwNLP5', '', 'i6sZpcY30eItQPfCKpe14w', (__DIR__.'/pools'), $a));
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('6LpzRT-GsN', '', 'i6sZpcY30eItQPfCKpe14w', (__DIR__.'/pools'), $a));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3307, 'dbname' => 'donation-activity', 'user' => 'root', 'password' => 'phpMyAdmin974!', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\Donation\\DonationBundle\\Entity'))), 'Donation\\DonationBundle\\Entity');
        ...
        $b->setEntityNamespaces(array('DonationBundle' => 'Donation\\DonationBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_cecf00a1fca56bd568c20f5cd6d20e51265c3f14870563ca76ded8874abf7905');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Donation\\DonationBundle\\Entity\\Utilisateurs');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Donation\\DonationBundle\\Entity\\Utilisateurs');
    }
    ...
    {
        return $this->services['fos_user.registration.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_registration_form', 'Donation\\DonationBundle\\Form\\RegistrationUsersType', array(0 => 'Registration', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Donation\\DonationBundle\\Entity\\Utilisateurs');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Donation\\DonationBundle\\Entity\\Utilisateurs');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Donation\\DonationBundle\\Entity\\Utilisateurs');
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/register/association');
        ...
        $m = new \Symfony\Component\HttpFoundation\RequestMatcher('^/association');

        $n = new \Symfony\Component\HttpFoundation\RequestMatcher('^/particulier');
        ...
        $o->add($n, array(0 => 'ROLE_PARTICULIER'), NULL);
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Donation\\DonationBundle/Resources/views'), 'Donation');
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_ASSOCIATION' => array(0 => 'ROLE_USER'), 'ROLE_PARTICULIER' => array(0 => 'ROLE_USER'), 'ROLE_ADMIN' => array(0 => 'ROLE_USER'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'DonationBundle' => 'Donation\\DonationBundle\\DonationBundle',
            ...
            'database_port' => 3307,
            'database_name' => 'donation-activity',
            'database_user' => 'root',
            'database_password' => 'phpMyAdmin974!',
            ...
            'fos_user.model.user.class' => 'Donation\\DonationBundle\\Entity\\Utilisateurs',
            ...
            'fos_user.registration.form.type' => 'Donation\\DonationBundle\\Form\\RegistrationUsersType',
