...
use Donation\DonationBundle\Form\RegistrationAssociationType;
use Donation\DonationBundle\Form\RegistrationUsersType;
use Symfony\Component\Form\Forms;
use Donation\DonationBundle\Entity\Utilisateurs;
...
class RegistrationController extends baseController
{
    public function registerAssociationAction(Request $request)
    {
        ...
        $form = $formFactory->create(RegistrationAssociationType::class,$user);
        $form->setData($user);
    ...
    public function registerParticulierAction(Request $request)
    {
        ...
        $form = $formFactory->create(RegistrationUsersType::class,$user);
        $form->setData($user);
